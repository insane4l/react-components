...
export const SuperDoubleRange: React.FC<SuperDoubleRangePropsType> = (
    ...
    const commonProps = {min, max, step, disabled: disable, className: "superDoubleRange__input", type: "range"}
    
    return (
        <div className="superDoubleRange__slider-wrapper">
...
const SelectedRangeLine: React.FC<{values: [number, number], maxValue: number}> = ({values, maxValue}) => {
    ...
    return (
        <div style={rangeSelectedLineStyle} className="superDoubleRange__selected-line"></div>
    )
}
...
const ValueIndicator: React.FC<{currentValue: number, maxValue: number}> = ({currentValue, maxValue}) => {
    ...
    return (
        <div style={{left: valueIndicatorPosition}} className="superDoubleRange__value-indicator" >
            <div>
                {currentValue}
            </div>
        </div>
